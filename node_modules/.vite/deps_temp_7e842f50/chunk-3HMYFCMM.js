...
function coinbaseWalletSDK(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbase-web-TRE6V35Q.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbase-web-TRE6V35Q.js");
      const provider = await args.providerFactory();
...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-HXRAIVNT.js");
...
function smartWallet(createOptions) {
  ...
  return {
    autoConnect: async (options) => {
      const { connectSmartAccount: connectSmartWallet } = await import("./smart-4EXNOM64.js");
    ...
    connect: async (options) => {
      const { connectSmartAccount } = await import("./smart-4EXNOM64.js");
    ...
    disconnect: async () => {
      if (account) {
        const { disconnectSmartAccount } = await import("./smart-4EXNOM64.js");
...
function createWallet(...args) {
  ...
  switch (true) {
    ...
    default: {
      ...
      const wallet = {
        autoConnect: async (options) => {
          const { injectedProvider: injectedProvider2 } = await import("./mipdStore-SPUCO2WD.js");
          if (id !== "walletConnect" && injectedProvider2(id)) {
            const { autoConnectEip1193Wallet: autoConnectEip1193Wallet2 } = await import("./injected-Y22BWMLF.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-WJIUCKKC.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            var _a;
            const { connectWC } = await import("./controller-WJIUCKKC.js");
            let qrOverlay;
            try {
          ...
          if (injectedProvider2(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet: connectEip1193Wallet2 } = await import("./injected-Y22BWMLF.js");
...
//# sourceMappingURL=chunk-3HMYFCMM.js.map
