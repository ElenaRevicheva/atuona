...
async function isOpStackChain(chain) {
  ...
  try {
    const { getChainMetadata } = await import("./utils-GQVGYBG7.js");
...
async function estimateGasCost(options) {
  ...
  if (await isOpStackChain(transaction.chain)) {
    const { estimateL1Fee } = await import("./estimate-l1-fee-SRY4H3NY.js");
...
//# sourceMappingURL=chunk-MQJEOAPA.js.map
