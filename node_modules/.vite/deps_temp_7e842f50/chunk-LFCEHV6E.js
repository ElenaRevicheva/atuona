...
var BLAKE2s = class extends BLAKE {
  constructor(opts = {}) {
    ...
    if (opts.salt) {
      const salt = u32(toBytes2(opts.salt));
      this.v4 ^= byteSwapIfBE(salt[0]);
      this.v5 ^= byteSwapIfBE(salt[1]);
    }
    if (opts.personalization) {
      const pers = u32(toBytes2(opts.personalization));
...
var BLAKE3 = class _BLAKE3 extends BLAKE {
  constructor(opts = {}, flags = 0) {
    ...
    if (opts.key !== void 0 && opts.context !== void 0)
      ...
      const key = toBytes2(opts.key).slice();
      if (key.length !== 32)
...
function fromHex5(hex, group) {
  return fromBytes5(toBytes(hex), group);
}
...
function ecdsa(Point2, hash3, ecdsaOpts = {}) {
  ...
  function validateSigLength(bytes, format4) {
    ...
    const sizer = format4 === "compact" ? size4 : format4 === "recovered" ? size4 + 1 : void 0;
    return _abytes2(bytes, sizer, `${format4} signature`);
  }
  class Signature {
    ...
    static fromBytes(bytes, format4 = defaultSigOpts_format) {
    ...
    toBytes(format4 = defaultSigOpts_format) {
      validateSigFormat(format4);
      if (format4 === "der")
  ...
  function verify5(signature, message, publicKey, opts = {}) {
    const { lowS, prehash, format: format4 } = validateSigOpts(opts, defaultSigOpts);
    publicKey = ensureBytes2("publicKey", publicKey);
    message = validateMsgAndHash(ensureBytes2("message", message), prehash);
    if ("strict" in opts)
      throw new Error("options.strict was renamed to lowS");
    const sig = format4 === void 0 ? tryParsingSig(signature) : Signature.fromBytes(ensureBytes2("sig", signature), format4);
    if (sig === false)
      return false;
    try {
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-LFCEHV6E.js.map
