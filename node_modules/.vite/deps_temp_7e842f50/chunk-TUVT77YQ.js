...
async function resolveAbiFromBytecode(contract) {
  const [{ resolveImplementation }, { extractIPFSUri }] = await Promise.all([
    import("./resolveImplementation-ITVID7VU.js"),
    import("./extractIPFS-OXPOCBRT.js")
  ]);
...
async function resolvePluginPatternAddresses(contract) {
  try {
    const { readContract } = await import("./read-contract-BP2MTJPT.js");
...
async function resolveModularModuleAddresses(contract) {
  try {
    const { getInstalledModules } = await import("./getInstalledModules-XTP5ZMWY.js");
...
async function estimateGas2(options) {
  ...
  const promise = (async () => {
    ...
    const { encode } = await import("./encode-WWDAOEFZ.js");
    ...
    const [{ getRpcClient: getRpcClient2 }, { eth_estimateGas }] = await Promise.all([
      import("./rpc-HE566RUS.js"),
      import("./eth_estimateGas-UQMIGQRU.js")
    ]);
...
//# sourceMappingURL=chunk-TUVT77YQ.js.map
