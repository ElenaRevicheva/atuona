...
async function createWalletConnectClient(options) {
  ...
  walletConnectClient.on("session_proposal", async (event) => {
    const { onSessionProposal } = await import("./session-proposal-7EQJEANK.js");
  ...
  walletConnectClient.on("session_request", async (event) => {
    const { fulfillRequest } = await import("./session-request-CQXVAEZ3.js");
...
*/
//# sourceMappingURL=chunk-FJZPVQ4J.js.map
