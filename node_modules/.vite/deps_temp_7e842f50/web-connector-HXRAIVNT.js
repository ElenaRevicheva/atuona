  ...
  async getAccount() {
    ...
    const _signTransaction = async (tx) => {
      ...
      const transaction = {
        ...
        data: tx.data,
        gas: hexlify(tx.gas),
        nonce: hexlify(tx.nonce) || toHex(await import("./eth_getTransactionCount-S42T2U6B.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
var InAppWebConnector = class {
  ...
  async passkeyAuth(args) {
    const { PasskeyWebClient } = await import("./passkeys-KU2MDSF6.js");
...
//# sourceMappingURL=web-connector-HXRAIVNT.js.map
