...
async function getNFTFromRPC(options) {
  ...
  const [uri, owner] = await Promise.all([
    ...
    options.includeOwner ? import("./ownerOf-WN2OLXPQ.js").then((m) => m.ownerOf({ contract: options.contract, tokenId })).catch(() => null) : null
  ]);
...
//# sourceMappingURL=chunk-SNVLND6U.js.map
