  ...
  return approve({
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals } = await import("./decimals-2TORLWA7.js");
...
async function createSmartAccount(options) {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      ...
      const { smartAccountSignMessage } = await import("./signing-SOAMRLJR.js");
    ...
    async signTypedData(typedData) {
      ...
      const { smartAccountSignTypedData } = await import("./signing-SOAMRLJR.js");
    ...
    sendCalls: async (options2) => {
      const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-VG22T562.js");
    ...
    getCallsStatus: async (options2) => {
      const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-VG22T562.js");
...
//# sourceMappingURL=chunk-5ZRZ6CQT.js.map
