import {
  ...
  encodeClaim,
  isClaimToSupported
} from "./chunk-FJUT5MJA.js";
import {
  getClaimParams
} from "./chunk-TALYNBGO.js";
import {
  isSetClaimConditionsSupported,
  setClaimConditions
} from "./chunk-JRJVBJ7D.js";
import {
  convertErc20Amount
} from "./chunk-IFS4IS5I.js";
import {
  isSetContractURISupported
} from "./chunk-IX4GA5HC.js";
import {
  isSetClaimConditionsSupported as isSetClaimConditionsSupported2
} from "./chunk-KXDFHNMV.js";
import {
  setApprovalForAll
} from "./chunk-VIOKBY7D.js";
import "./chunk-Y4FXVQH4.js";
import {
...
} from "./chunk-6T5INN3C.js";
import {
  MerkleTree,
  hashEntry
} from "./chunk-QBZNXTE5.js";
import {
  getApproved,
  isGetApprovedSupported
} from "./chunk-46VHRB67.js";
import {
  isApprovedForAll
} from "./chunk-XOHOWRKF.js";
import {
  ownerOf
} from "./chunk-F7NZOAF5.js";
import {
  upload
...
async function getMulticallSetClaimConditionTransactions(options) {
  ...
  if (Object.keys(merkleInfos).length > 0) {
    const [{ getContractMetadata }, { encodeSetContractURI }] = await Promise.all([
      ...
      import("./setContractURI-IIMSQALF.js")
    ]);
  ...
  if (options.tokenId !== void 0) {
    if (options.singlePhase) {
      const { encodeSetClaimConditions } = await import("./setClaimConditions-AJ2ATHBY.js");
      ...
      const { encodeSetClaimConditions } = await import("./setClaimConditions-ANNEYTDT.js");
      encodedSetClaimConditions = encodeSetClaimConditions({
        phases: sortedPhases,
        resetClaimEligibility: options.resetClaimEligibility || false,
        tokenId: options.tokenId
    ...
    if (options.singlePhase) {
      const { encodeSetClaimConditions } = await import("./setClaimConditions-SNPF7JZI.js");
      const phase = sortedPhases[0];
      if (!phase) {
        throw new Error("No phase provided");
      }
      ...
      const { encodeSetClaimConditions } = await import("./setClaimConditions-IRDM5RQ6.js");
      encodedSetClaimConditions = encodeSetClaimConditions({
        phases: sortedPhases,
        resetClaimEligibility: options.resetClaimEligibility || false
      });
...
async function generateMintSignature(options) {
  ...
  const [price, uri, uid] = await Promise.all([
    ...
    (async () => {
      ...
      if ("price" in mintRequest && mintRequest.price) {
        const { convertErc20Amount: convertErc20Amount2 } = await import("./convert-erc20-amount-SAWQ2ILB.js");
  ...
  if (((_a = mintRequest.primarySaleRecipient) == null ? void 0 : _a.length) === 0 || !mintRequest.primarySaleRecipient) {
    const { primarySaleRecipient } = await import("./primarySaleRecipient-YMFLF4VR.js");
  ...
  if (((_b = mintRequest.royaltyRecipient) == null ? void 0 : _b.length) === 0 || !mintRequest.royaltyRecipient) {
    const { getDefaultRoyaltyInfo } = await import("./getDefaultRoyaltyInfo-T2UKT63N.js");
