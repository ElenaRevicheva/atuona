...
import {
  ...
  setClaimConditions
} from "./chunk-MAJO4ZXK.js";
import {
  convertErc20Amount
} from "./chunk-WDUR2X5F.js";
import {
  isSetContractURISupported
} from "./chunk-PRCCZKYG.js";
import {
  isSetClaimConditionsSupported as isSetClaimConditionsSupported2
} from "./chunk-PWEFQ635.js";
import {
  isApprovedForAll
} from "./chunk-JZ6QGNDF.js";
import {
  setApprovalForAll
} from "./chunk-UIFWHXRQ.js";
import "./chunk-5RY6FRS4.js";
import {
...
} from "./chunk-QV4HB4XX.js";
import {
  ownerOf
} from "./chunk-F4LHSZQR.js";
import {
  upload
} from "./chunk-7QYG5KJB.js";
import {
  balanceOf,
  getOwnedNFTs,
  getOwnedTokenIds,
...
import {
  min,
  toBigInt
} from "./chunk-2DKD2QB6.js";
import "./chunk-HTUZDPX7.js";
import {
  getContractNFTs
...
async function getMulticallSetClaimConditionTransactions(options) {
  ...
  if (Object.keys(merkleInfos).length > 0) {
    const [{ getContractMetadata }, { encodeSetContractURI }] = await Promise.all([
      ...
      import("./setContractURI-FCZL5PF4.js")
    ]);
  ...
  if (options.tokenId !== void 0) {
    if (options.singlePhase) {
      const { encodeSetClaimConditions } = await import("./setClaimConditions-MLE5ZYF4.js");
      ...
      const { encodeSetClaimConditions } = await import("./setClaimConditions-QNQGIYBT.js");
      encodedSetClaimConditions = encodeSetClaimConditions({
        phases: sortedPhases,
        resetClaimEligibility: options.resetClaimEligibility || false,
        tokenId: options.tokenId
    ...
    if (options.singlePhase) {
      const { encodeSetClaimConditions } = await import("./setClaimConditions-Q2BXMWFZ.js");
      const phase = sortedPhases[0];
      if (!phase) {
        throw new Error("No phase provided");
      }
      ...
      const { encodeSetClaimConditions } = await import("./setClaimConditions-Z5F6UD6E.js");
      encodedSetClaimConditions = encodeSetClaimConditions({
        phases: sortedPhases,
        resetClaimEligibility: options.resetClaimEligibility || false
      });
...
async function getUpdateMetadataParams(options) {
  ...
  const { uploadOrExtractURIs: uploadOrExtractURIs2 } = await import("./ipfs-TDDFPCT5.js");
  ...
  return mintTo({
    asyncParams: async () => {
      ...
      if (typeof options.nft === "string") {
        ...
        const { upload: upload2 } = await import("./upload-P73JXRUY.js");
...
async function generateMintSignature(options) {
  ...
  const [price, uri, uid] = await Promise.all([
    ...
    (async () => {
      ...
      if ("price" in mintRequest && mintRequest.price) {
        const { convertErc20Amount: convertErc20Amount2 } = await import("./convert-erc20-amount-YNIB5UGU.js");
  ...
  if (((_a = mintRequest.primarySaleRecipient) == null ? void 0 : _a.length) === 0 || !mintRequest.primarySaleRecipient) {
    const { primarySaleRecipient } = await import("./primarySaleRecipient-GILWJZK3.js");
  ...
  if (((_b = mintRequest.royaltyRecipient) == null ? void 0 : _b.length) === 0 || !mintRequest.royaltyRecipient) {
    const { getDefaultRoyaltyInfo } = await import("./getDefaultRoyaltyInfo-VNKKTY27.js");
