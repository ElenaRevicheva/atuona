...
function createWallet(...args) {
  ...
  switch (true) {
    ...
    default: {
      ...
      const wallet = {
        autoConnect: async (options) => {
          const { injectedProvider: injectedProvider2 } = await import("./mipdStore-CQSQJWNU.js");
          if (id !== "walletConnect" && injectedProvider2(id)) {
            const { autoConnectEip1193Wallet: autoConnectEip1193Wallet2 } = await import("./injected-JLLBTKHU.js");
        ...
        connect: async (options) => {
          ...
          if (injectedProvider2(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet: connectEip1193Wallet2 } = await import("./injected-JLLBTKHU.js");
...
//# sourceMappingURL=chunk-OCHDCHHC.js.map
