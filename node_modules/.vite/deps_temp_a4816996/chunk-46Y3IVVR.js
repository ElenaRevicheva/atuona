...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-MROG52FG.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-ILJD6M4G.js");
      return getNFT(options);
    }
    default: {
...
//# sourceMappingURL=chunk-46Y3IVVR.js.map
