  ...
  async getAccount() {
    ...
    const _signTransaction = async (tx) => {
      ...
      const transaction = {
        ...
        data: tx.data,
        gas: hexlify(tx.gas),
        nonce: hexlify(tx.nonce) || toHex(await import("./eth_getTransactionCount-DB3U5W6I.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
//# sourceMappingURL=web-connector-W2TAX6U2.js.map
