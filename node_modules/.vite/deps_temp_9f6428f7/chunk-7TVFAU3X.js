  ...
  return approve({
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals } = await import("./decimals-6RN5WQ57.js");
...
async function createSmartAccount(options) {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      ...
      const { smartAccountSignMessage } = await import("./signing-KI2HO7VZ.js");
    ...
    async signTypedData(typedData) {
      ...
      const { smartAccountSignTypedData } = await import("./signing-KI2HO7VZ.js");
    ...
    sendCalls: async (options2) => {
      const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-HXDYB6MD.js");
    ...
    getCallsStatus: async (options2) => {
      const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-HXDYB6MD.js");
...
//# sourceMappingURL=chunk-7TVFAU3X.js.map
