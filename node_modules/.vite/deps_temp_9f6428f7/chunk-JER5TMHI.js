...
import {
  normalizeChainId
} from "./chunk-QGVSJ73L.js";
import {
  isBrowser
} from "./chunk-5GPJCQB3.js";
import {
  parseTypedData
} from "./chunk-3BPUUVH2.js";
import {
  getDefaultAccountFactory
} from "./chunk-BGPDCT23.js";
import {
  isContractDeployed
...
function coinbaseWalletSDK(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbase-web-M4M2RBJS.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbase-web-M4M2RBJS.js");
      const provider = await args.providerFactory();
...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-65INCMEH.js");
...
function smartWallet(createOptions) {
  ...
  return {
    autoConnect: async (options) => {
      const { connectSmartAccount: connectSmartWallet } = await import("./smart-YCUAP7QT.js");
    ...
    connect: async (options) => {
      const { connectSmartAccount } = await import("./smart-YCUAP7QT.js");
    ...
    disconnect: async () => {
      if (account) {
        const { disconnectSmartAccount } = await import("./smart-YCUAP7QT.js");
...
function createWallet(...args) {
  ...
  switch (true) {
    ...
    default: {
      ...
      const wallet = {
        autoConnect: async (options) => {
          const { injectedProvider: injectedProvider2 } = await import("./mipdStore-YNP43DV7.js");
          if (id !== "walletConnect" && injectedProvider2(id)) {
            const { autoConnectEip1193Wallet: autoConnectEip1193Wallet2 } = await import("./injected-ZATTGKU3.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-JL45BYHT.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            var _a;
            const { connectWC } = await import("./controller-JL45BYHT.js");
            let qrOverlay;
            try {
          ...
          if (injectedProvider2(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet: connectEip1193Wallet2 } = await import("./injected-ZATTGKU3.js");
...
//# sourceMappingURL=chunk-JER5TMHI.js.map
