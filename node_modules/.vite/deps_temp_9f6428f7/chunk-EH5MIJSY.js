...
async function getNonce(args) {
  ...
  const nonce = await import("./eth_getTransactionCount-S42T2U6B.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
    address,
    blockTag: "pending"
  }));
  return nonce;
...
//# sourceMappingURL=chunk-EH5MIJSY.js.map
