...
async function sendTransaction(options) {
  ...
  if (transaction.eip712) {
    const { sendEip712Transaction } = await import("./send-eip712-transaction-7V674N7M.js");
  ...
  if (gasless) {
    const { sendGaslessTransaction } = await import("./send-gasless-transaction-3YK46CXO.js");
...
//# sourceMappingURL=chunk-PNMN7VCE.js.map
