...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-VVSGGY4W.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-423L2O7E.js");
      return getNFT(options);
    }
    default: {
...
//# sourceMappingURL=chunk-PKIS2QV6.js.map
