...
} from "./chunk-UWS62EZ6.js";
import {
  hasStoredPasskey
} from "./chunk-GJTYI73B.js";
import {
  getDefaultWallets
...
function GuestLogin(props) {
  ...
  return (0, import_jsx_runtime.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: (0, import_jsx_runtime.jsxs)(Container, { expand: true, flex: "column", p: "lg", style: {
    paddingBottom: 0
...
function OTPInput(props) {
  return (0, import_jsx_runtime2.jsx)(OTPInputContainer, { children: (0, import_jsx_runtime2.jsx)(Lt, { maxLength: 6, onChange: (newValue) => {
...
function OTPLoginUI(props) {
  ...
  if (screen === "base") {
    return (0, import_jsx_runtime3.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: [(0, import_jsx_runtime3.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime3.jsx)(ModalHeader, { onBack: goBack, title: locale.signIn }) }), (0, import_jsx_runtime3.jsx)(Container, { center: "y", expand: true, flex: "column", children: (0, import_jsx_runtime3.jsxs)("form", { onSubmit: (e) => {
      e.preventDefault();
    }, children: [(0, import_jsx_runtime3.jsxs)(Container, { center: "x", flex: "column", px: "lg", children: [!isWideModal && (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime3.jsx)(Text, { children: locale.emailLoginScreen.enterCodeSendTo }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime3.jsx)(Text, { color: "primaryText", children: "email" in userInfo ? userInfo.email : userInfo.phone }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" })] }), (0, import_jsx_runtime3.jsx)(OTPInput, { digits: 6, isInvalid: verifyStatus === "invalid", onEnter: () => {
      verify(otpInput);
    }, setValue: (value) => {
      setOtpInput(value);
      setVerifyStatus("idle");
    }, value: otpInput }), verifyStatus === "invalid" && (0, import_jsx_runtime3.jsxs)(FadeIn, { children: [(0, import_jsx_runtime3.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", children: locale.emailLoginScreen.invalidCode })] }), verifyStatus === "linking_error" && (0, import_jsx_runtime3.jsxs)(FadeIn, { children: [(0, import_jsx_runtime3.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", children: error || "Failed to verify code" })] }), verifyStatus === "payment_required" && (0, import_jsx_runtime3.jsxs)(FadeIn, { children: [(0, import_jsx_runtime3.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", children: locale.maxAccountsExceeded })] }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime3.jsx)(Container, { px: isWideModal ? "xxl" : "lg", children: verifyStatus === "verifying" ? (0, import_jsx_runtime3.jsx)(Container, { animate: "fadein", center: "x", flex: "row", children: (0, import_jsx_runtime3.jsx)(Spinner, { color: "accentText", size: "lg" }) }) : (0, import_jsx_runtime3.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime3.jsx)(Button, { onClick: () => verify(otpInput), style: {
      width: "100%"
    }, type: "submit", variant: "accent", children: locale.emailLoginScreen.verify }) }, "btn-container") }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" }), !isWideModal && (0, import_jsx_runtime3.jsx)(Line, {}), (0, import_jsx_runtime3.jsxs)(Container, { gap: "xs", p: isWideModal ? void 0 : "lg", children: [accountStatus === "error" && (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", children: locale.emailLoginScreen.failedToSendCode }), accountStatus === "sending" && (0, import_jsx_runtime3.jsxs)(Container, { center: "both", flex: "row", gap: "xs", style: {
      textAlign: "center"
    }, children: [(0, import_jsx_runtime3.jsx)(Text, { size: "sm", children: locale.emailLoginScreen.sendingCode }), (0, import_jsx_runtime3.jsx)(Spinner, { color: "secondaryText", size: "xs" })] }), accountStatus !== "sending" && (0, import_jsx_runtime3.jsx)(LinkButton, { onClick: countdown === 0 ? sendEmailOrSms : void 0, style: {
...
var AccentFailIcon = (props) => {
  const linearGradientId = (0, import_react4.useId)();
  const clipPathId = (0, import_react4.useId)();
...
function PassKeyLogin(props) {
  ...
  const [screen, setScreen] = (0, import_react5.useState)("loading");
  const triggered = (0, import_react5.useRef)(false);
...
function SocialLogin(props) {
  ...
  const [authError, setAuthError] = (0, import_react6.useState)(void 0);
  const { done, wallet } = props;
  const [status, setStatus] = (0, import_react6.useState)("connecting");
  ...
  const socialLoginStarted = (0, import_react6.useRef)(false);
  ...
  return (0, import_jsx_runtime8.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: (0, import_jsx_runtime8.jsxs)(Container, { expand: true, flex: "column", p: "lg", style: {
    paddingBottom: 0
...
async function getSmartWalletLocale(localeId) {
  switch (localeId) {
    case "es_ES":
      return (await import("./es-QUMWKGTQ.js")).default;
    case "ja_JP":
      return (await import("./ja-VTRVB3CA.js")).default;
    case "tl_PH":
      return (await import("./tl-7QILTDSI.js")).default;
    case "vi_VN":
      return (await import("./vi-S7NPMTMF.js")).default;
    case "de_DE":
      return (await import("./de-ECGV5C6K.js")).default;
    case "ko_KR":
      return (await import("./kr-SEU4OHWN.js")).default;
    case "fr_FR":
      return (await import("./fr-QJXORGCE.js")).default;
    case "ru_RU":
      return (await import("./ru-YCVZXKP5.js")).default;
    case "pt_BR": {
      return (await import("./br-E5IKVP5P.js")).default;
    }
    case "zh_CN":
      return (await import("./zh-25S3AYMK.js")).default;
    default:
      return (await import("./en-GT5XGGPM.js")).default;
  }
}
...
async function getInjectedWalletLocale(locale) {
  switch (locale) {
    case "es_ES":
      return (await import("./es-EY54ZLIQ.js")).default;
    case "ja_JP":
      return (await import("./ja-WKNAJFJ6.js")).default;
    case "tl_PH":
      return (await import("./tl-ABAY7L4B.js")).default;
    case "vi_VN":
      return (await import("./vi-YLX57LNS.js")).default;
    case "de_DE":
      return (await import("./de-4TSOVUEH.js")).default;
    case "ko_KR":
      return (await import("./kr-6RVD2VKZ.js")).default;
    case "fr_FR":
      return (await import("./fr-DFPTHHBV.js")).default;
    case "ru_RU":
      return (await import("./ru-4RYZXOBU.js")).default;
    case "pt_BR": {
      return (await import("./br-EWFA6JIG.js")).default;
    }
    case "zh_CN":
      return (await import("./zh-4FTV5WDF.js")).default;
    default:
      return (await import("./en-M52BNASW.js")).default;
  }
}
...
var QRCode = (props) => {
  ...
  return (0, import_jsx_runtime12.jsxs)("div", { style: {
    ...
    justifyContent: "center",
    position: "relative"
  }, children: [props.qrCodeUri ? (0, import_jsx_runtime12.jsx)(import_react8.Suspense, { fallback: placeholder, children: (0, import_jsx_runtime12.jsx)(QRCodeContainer, { children: (0, import_jsx_runtime12.jsx)(QRCodeRenderer, { clearSize: props.QRIcon ? 70 : void 0, ecl: "M", size: size + 20, uri: props.qrCodeUri }) }) }) : placeholder, props.QRIcon && (0, import_jsx_runtime12.jsx)(IconContainer, { children: props.QRIcon })] });
};
...
var GetStartedScreen = ({ wallet, walletInfo, header, footer, onBack, locale, client }) => {
  const [showScreen, setShowScreen] = (0, import_react9.useState)("base");
  ...
  return (0, import_jsx_runtime13.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: (0, import_jsx_runtime13.jsxs)(Container, { expand: true, flex: "column", p: "lg", children: [showScreen === "android-scan" && walletInfo.app.android && (0, import_jsx_runtime13.jsx)(InstallScanScreen, { client, locale: {
    scanToDownload: locale.getStartedScreen.instruction
  }, onBack: handleBack, platform: "Google Play", platformIcon: (0, import_jsx_runtime13.jsx)(PlayStoreIcon, { size: iconSize.md }), url: walletInfo.app.android, walletId: wallet.id, walletName: walletInfo.name }), showScreen === "ios-scan" && walletInfo.app.ios && (0, import_jsx_runtime13.jsx)(InstallScanScreen, { client, locale: {
    scanToDownload: locale.getStartedScreen.instruction
  }, onBack: handleBack, platform: "App Store", platformIcon: (0, import_jsx_runtime13.jsx)(AppleIcon, { size: iconSize.md }), url: walletInfo.app.ios, walletId: wallet.id, walletName: walletInfo.name }), showScreen === "base" && (0, import_jsx_runtime13.jsxs)(Container, { expand: true, flex: "column", children: [header || (0, import_jsx_runtime13.jsx)(ModalHeader, { onBack: handleBack, title: walletInfo.name }), (0, import_jsx_runtime13.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime13.jsx)(Container, { animate: "fadein", center: "y", expand: true, flex: "column", style: {
    minHeight: "250px"
...
var InstallScanScreen = (props) => {
  return (0, import_jsx_runtime13.jsxs)(Container, { animate: "fadein", expand: true, children: [(0, import_jsx_runtime13.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletName }), (0, import_jsx_runtime13.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime13.jsxs)(Container, { center: "both", expand: true, flex: "column", style: {
    textAlign: "center"
  }, children: [(0, import_jsx_runtime13.jsx)(QRCode, { QRIcon: (0, import_jsx_runtime13.jsx)(WalletImage, { client: props.client, id: props.walletId, size: iconSize.xxl }), qrCodeUri: props.url }), (0, import_jsx_runtime13.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime13.jsx)(Text, { balance: true, center: true, multiline: true, children: props.locale.scanToDownload }), (0, import_jsx_runtime13.jsx)(Spacer, { y: "xs" })] })] });
};
...
var ScanScreen = (props) => {
  ...
  const [linkCopied, setLinkCopied] = (0, import_react10.useState)(false);
  return (0, import_jsx_runtime14.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: [(0, import_jsx_runtime14.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime14.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletName }) }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime14.jsxs)(Container, { center: "both", expand: true, flex: "column", px: "lg", children: [!props.error && (0, import_jsx_runtime14.jsxs)("div", { style: {
    textAlign: "center"
  }, children: [(0, import_jsx_runtime14.jsx)(QRCode, { QRIcon: (0, import_jsx_runtime14.jsx)(WalletImage, { client, id: props.walletId, size: iconSize.xxl }), qrCodeUri: props.qrCodeUri }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime14.jsxs)(Button, { disabled: props.qrCodeUri === void 0, onClick: () => {
  ...
  }, variant: "link", children: [linkCopied ? (0, import_jsx_runtime14.jsx)(CheckIcon, { height: 14, width: 14 }) : (0, import_jsx_runtime14.jsx)(CopyIcon, { height: 14, width: 14 }), (0, import_jsx_runtime14.jsx)("span", { style: { padding: "0 4px" }, children: "Copy Link" })] }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime14.jsx)(Text, { balance: true, center: true, multiline: true, style: {
    paddingInline: spacing.lg
  }, children: props.qrScanInstruction })] }), props.error && (0, import_jsx_runtime14.jsxs)(Container, { animate: "fadein", style: {
    width: "100%"
  }, children: [(0, import_jsx_runtime14.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime14.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime14.jsx)(AccentFailIcon, { size: iconSize["3xl"] }) }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime14.jsx)(Text, { center: true, color: "primaryText", size: "lg", children: "Connection Failed" }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "3xl" }), (0, import_jsx_runtime14.jsx)(Button, { fullWidth: true, onClick: props.onRetry, variant: "accent", children: "Try again" })] })] }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "lg" }), props.onGetStarted && (0, import_jsx_runtime14.jsx)(ScreenBottomContainer, { style: {
    border: connectModalSize === "compact" ? void 0 : "none"
  }, children: (0, import_jsx_runtime14.jsx)(Button, { onClick: props.onGetStarted, style: {
    fontSize: fontSize.sm,
    textAlign: "center"
...
var WalletConnectConnection = (props) => {
  ...
  const [qrCodeUri, setQrCodeUri] = (0, import_react11.useState)();
  const [errorConnecting, setErrorConnecting] = (0, import_react11.useState)(false);
  const connect = (0, import_react11.useCallback)(() => {
    var _a;
  ...
  const scanStarted = (0, import_react11.useRef)(false);
  ...
  if (isMobile()) {
    return (0, import_jsx_runtime15.jsx)(ConnectingScreen, { client: props.client, errorConnecting, locale: {
  ...
  return (0, import_jsx_runtime15.jsx)(ScanScreen, { client: props.client, connectModalSize: props.size, error: errorConnecting, getStartedLink: locale.getStartedLink, onBack, onGetStarted, onRetry: connect, qrCodeUri, qrScanInstruction: locale.scanScreen.instruction, walletId: wallet.id, walletName: walletInfo.name });
};
var WalletConnectStandaloneConnection = (props) => {
  ...
  return (0, import_jsx_runtime15.jsx)(ScanScreen, { client: props.client, connectModalSize: props.size, error: errorConnecting, getStartedLink: locale.getStartedLink, onBack, onRetry: connect, qrCodeUri, qrScanInstruction: locale.scanScreen.instruction, walletId: wallet.id, walletName: walletInfo.name });
};
...
var DeepLinkConnectUI = (props) => {
  ...
  return (0, import_jsx_runtime16.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime16.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime16.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletInfo.name }) }), (0, import_jsx_runtime16.jsx)(Container, { animate: "fadein", center: "x", flex: "row", py: "3xl", children: (0, import_jsx_runtime16.jsx)(PulsatingContainer, { children: (0, import_jsx_runtime16.jsx)(WalletImage, { client: props.client, id: props.wallet.id, size: "80" }) }) }), (0, import_jsx_runtime16.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime16.jsxs)(ButtonLink, { fullWidth: true, gap: "xs", href: deeplink, variant: "accent", children: ["Continue in ", props.walletInfo.name, (0, import_jsx_runtime16.jsx)(ExternalLinkIcon, { height: iconSize.sm, width: iconSize.sm })] }) })] });
};
...
var InjectedConnectUI = (props) => {
  ...
  const [errorConnecting, setErrorConnecting] = (0, import_react13.useState)(false);
  const locale = props.locale;
  const connectToExtension = (0, import_react13.useCallback)(async () => {
    try {
  ...
  const connectPrompted = (0, import_react13.useRef)(false);
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/AnyWalletConnectUI.js
var CoinbaseSDKWalletConnectUI = (0, import_react14.lazy)(() => import("./CoinbaseSDKConnection-4OLGGGSR.js"));
var InAppWalletConnectUI = (0, import_react14.lazy)(() => import("./InAppWalletConnectUI-PE4WUL4F.js"));
var EcosystemWalletConnectUI = (0, import_react14.lazy)(() => import("./EcosystemWalletConnectUI-SJOTGM63.js"));
function AnyWalletConnectUI(props) {
  ...
  if (!walletInfo.data) {
    ...
    if (injectedProvider) {
      return (0, import_jsx_runtime18.jsx)(InjectedConnectUI, { chain: props.chain, client: props.client, done: props.done, locale: localeFn(injectedProvider.info.name), onBack: props.onBack, size: props.size, wallet: props.wallet, walletName: injectedProvider.info.name });
    }
    return (0, import_jsx_runtime18.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: [(0, import_jsx_runtime18.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime18.jsx)(ModalHeader, { onBack: props.onBack, title: "Not Supported" }) }), (0, import_jsx_runtime18.jsxs)(Container, { center: "both", expand: true, flex: "column", p: "lg", style: {
      minHeight: "300px"
    }, children: [(0, import_jsx_runtime18.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime18.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime18.jsx)(Text, { center: true, color: "primaryText", children: "Wallet is not supported" }), (0, import_jsx_runtime18.jsx)(Spacer, { y: "xxl" })] })] });
  }
  ...
  if (screen === "get-started") {
    return (0, import_jsx_runtime18.jsx)(GetStartedScreen, { client: props.client, locale, onBack: () => {
      setScreen("main");
  ...
  if (((_c = walletInfo.data.deepLink) == null ? void 0 : _c.mobile) && shouldDeeplink) {
    return (0, import_jsx_runtime18.jsx)(DeepLinkConnectUI, { client: props.client, deepLinkPrefix: walletInfo.data.deepLink.mobile, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
    }, wallet: props.wallet, walletInfo: walletInfo.data });
  }
  if (walletInfo.data.rdns && isInstalled) {
    return (0, import_jsx_runtime18.jsx)(InjectedConnectUI, { chain: props.chain, client: props.client, done: props.done, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
  ...
  if (walletInfo.data.mobile.native || walletInfo.data.mobile.universal) {
    return (0, import_jsx_runtime18.jsx)(WalletConnectConnection, { chain: props.chain, chains: props.chains, client: props.client, done: props.done, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
  ...
  if (props.wallet.id === "walletConnect") {
    return (0, import_jsx_runtime18.jsx)(WalletConnectStandaloneConnection, { chain: props.chain, chains: props.chains, client: props.client, done: props.done, locale, onBack: props.onBack, setModalVisibility: props.setModalVisibility, size: props.size, wallet: props.wallet, walletConnect: props.walletConnect, walletInfo: walletInfo.data });
  }
  if (props.wallet.id === "inApp" || props.wallet.id === "embedded") {
    return (0, import_jsx_runtime18.jsx)(import_react14.Suspense, { fallback: (0, import_jsx_runtime18.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime18.jsx)(InAppWalletConnectUI, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, done: props.done, goBack: props.onBack, meta: props.meta, size: props.size, wallet: props.wallet, walletConnect: props.walletConnect }) });
  }
  if (isEcosystemWallet(props.wallet.id)) {
    return (0, import_jsx_runtime18.jsx)(import_react14.Suspense, { fallback: (0, import_jsx_runtime18.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime18.jsx)(EcosystemWalletConnectUI, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, done: props.done, goBack: props.onBack, meta: props.meta, size: props.size, wallet: props.wallet, walletConnect: props.walletConnect }) });
  }
  if (props.wallet.id) {
    return (0, import_jsx_runtime18.jsx)(import_react14.Suspense, { fallback: (0, import_jsx_runtime18.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime18.jsx)(CoinbaseSDKWalletConnectUI, { chain: props.chain, client: props.client, done: props.done, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
    }, size: props.size, wallet: props.wallet, walletInfo: walletInfo.data }) });
  }
  return (0, import_jsx_runtime18.jsx)(GetStartedScreen, { client: props.client, locale, onBack: props.onBack, wallet: props.wallet, walletInfo: walletInfo.data });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/SmartWalletConnectUI.js
function SmartConnectUI(props) {
  const personalWalletInfo = useWalletInfo(props.personalWallet.id);
  const [keyConnected, setKeyConnected] = (0, import_react15.useState)(false);
  if (!personalWalletInfo.data) {
    return (0, import_jsx_runtime19.jsx)(LoadingScreen, {});
  }
  if (!keyConnected) {
    return (0, import_jsx_runtime19.jsx)(AnyWalletConnectUI, { chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, done: () => {
  ...
  return (0, import_jsx_runtime19.jsx)(SmartWalletConnecting, { accountAbstraction: props.accountAbstraction, client: props.client, done: props.done, localeId: props.connectLocale.id, onBack: props.onBack, personalWallet: props.personalWallet, personalWalletInfo: personalWalletInfo.data, size: props.size });
}
function SmartWalletConnecting(props) {
  ...
  const { done } = props;
  const [smartWalletConnectionStatus, setSmartWalletConnectionStatus] = (0, import_react15.useState)("idle");
  const connectionManager = useConnectionManager();
  const handleConnect = (0, import_react15.useCallback)(async () => {
    if (!personalWallet) {
  ...
  const connectStarted = (0, import_react15.useRef)(false);
  ...
  if (smartWalletConnectionStatus === "connect-error") {
    return (0, import_jsx_runtime19.jsx)(Container, { animate: "fadein", center: "both", flex: "column", fullHeight: true, p: "lg", style: {
      minHeight: "300px"
    }, children: (0, import_jsx_runtime19.jsx)(Text, { color: "danger", children: localeQuery.data.failedToConnect }) });
  }
  return (0, import_jsx_runtime19.jsxs)(Container, { center: "both", flex: "column", fullHeight: true, style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime19.jsx)(Text, { center: true, color: "primaryText", multiline: true, children: localeQuery.data.connecting }), (0, import_jsx_runtime19.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime19.jsx)(Spinner, { color: "accentText", size: "lg" })] });
}
...
function TOS(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime20.jsxs)(Text, { balance: true, center: true, inline: true, multiline: true, size: "xs", style: {
    maxWidth: "250px"
  }, children: [requireApproval && (0, import_jsx_runtime20.jsx)("input", { checked: props.isApproved, disabled: !requireApproval, onChange: props.onApprove, style: {
    marginRight: spacing["3xs"],
    transform: "translateY(3px)"
  }, type: "checkbox" }), locale.prefix, " ", termsOfServiceUrl && (0, import_jsx_runtime20.jsxs)(Link, { href: termsOfServiceUrl, inline: true, size: "xs", style: {
    whiteSpace: "nowrap"
  }, target: "_blank", children: [" ", locale.termsOfService, " "] }), bothGiven && `${locale.and} `, privacyPolicyUrl && (0, import_jsx_runtime20.jsx)(Link, { href: privacyPolicyUrl, inline: true, size: "xs", target: "_blank", children: locale.privacyPolicy }), !privacyPolicyUrl && !termsOfServiceUrl && (0, import_jsx_runtime20.jsx)(Text, { inline: true, size: "xs", children: "Terms of Service and Privacy Policy" })] }) });
}
...
function PoweredByThirdweb(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(Link, { color: "secondaryText", hoverColor: "primaryText", href: link, target: "_blank", children: (0, import_jsx_runtime22.jsxs)(Container, { center: "both", flex: "row", style: {
    color: "currentColor",
    gap: 4
  }, children: [(0, import_jsx_runtime22.jsx)(Text, { size: "xs", style: {
    color: "currentColor"
  }, weight: 600, children: "Powered by" }), (0, import_jsx_runtime22.jsx)(ThirdwebTextIcon, { height: 11 })] }) });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/WalletSelector.js
var InAppWalletSelectionUI = (0, import_react17.lazy)(() => import("./InAppWalletSelectionUI-TSA5KH45.js"));
...
//# sourceMappingURL=chunk-ZHF4B3JL.js.map
