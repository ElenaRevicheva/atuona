...
function CountrySelector({ countryCode, setCountryCode, allowedCountryCodes }) {
  ...
  return (0, import_jsx_runtime4.jsxs)(Select, { name: "countries", onChange: (e) => {
...
async function getInAppWalletLocale(localeId) {
  switch (localeId) {
    case "es_ES":
      return (await import("./es-GMRKWAH3.js")).default;
    case "ja_JP":
      return (await import("./ja-OSQS7ROF.js")).default;
    case "tl_PH":
      return (await import("./tl-6QNDHN5M.js")).default;
    case "vi_VN":
      return (await import("./vi-EN57KM47.js")).default;
    case "de_DE":
      return (await import("./de-77A4BK7E.js")).default;
    case "ko_KR":
      return (await import("./kr-TDG3NNTE.js")).default;
    case "fr_FR":
      return (await import("./fr-3E7U3S77.js")).default;
    case "ru_RU":
      return (await import("./ru-3FROXIYF.js")).default;
    case "pt_BR": {
      return (await import("./br-BSTKMZXD.js")).default;
    }
    case "zh_CN":
      return (await import("./zh-FGAOB2B5.js")).default;
    default:
      return (await import("./en-OWZP6GUV.js")).default;
  }
}
...
//# sourceMappingURL=chunk-BCSHXXNG.js.map
