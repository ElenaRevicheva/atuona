...
async function resolveAbiFromBytecode(contract) {
  const [{ resolveImplementation }, { extractIPFSUri }] = await Promise.all([
    import("./resolveImplementation-ZI43U2O6.js"),
    import("./extractIPFS-MZHCYJBI.js")
  ]);
...
async function resolvePluginPatternAddresses(contract) {
  try {
    const { readContract } = await import("./read-contract-7FE3H6HB.js");
...
async function resolveModularModuleAddresses(contract) {
  try {
    const { getInstalledModules } = await import("./getInstalledModules-I4TLFCS5.js");
...
async function estimateGas2(options) {
  ...
  const promise = (async () => {
    ...
    const { encode } = await import("./encode-D7G3IYT2.js");
    ...
    const [{ getRpcClient: getRpcClient2 }, { eth_estimateGas }] = await Promise.all([
      import("./rpc-FEAYDIC2.js"),
      import("./eth_estimateGas-7SCT5TVZ.js")
    ]);
...
//# sourceMappingURL=chunk-WZWH6DQ2.js.map
