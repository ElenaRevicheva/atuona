...
async function toSerializableTransaction(options) {
  ...
  if (isZkSync) {
    const { getZkGasFees } = await import("./send-eip712-transaction-JX7JOAHE.js");
  ...
  let [data, nonce, gas, feeData, to, accessList, value, authorizationList, type] = await Promise.all([
    ...
    (async () => {
      ...
      return from ? await import("./eth_getTransactionCount-DB3U5W6I.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
//# sourceMappingURL=chunk-2BVO2OWV.js.map
