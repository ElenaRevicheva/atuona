...
function useSendTransaction(config = {}) {
    ...
    const showPayModal = (data) => {
        if (payModal === false)
            return;
        setRootEl((0, jsx_runtime_1.jsx)(TransactionModal_js_1.TransactionModal, { country: payModal?.country, client: data.tx.client, localeId: payModal?.locale || "en_US", modalMode: data.mode, onClose: () => {
                setRootEl(null);
