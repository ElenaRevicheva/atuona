...
function TransactionModalContent(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(BridgeOrchestrator_js_1.BridgeOrchestrator, { country: props.country, client: props.client, connectLocale: localeQuery.data, connectOptions: undefined, onCancel: props.onClose, onComplete: () => {
            setScreen("execute-tx");
