...
export function BridgeOrchestrator({ client, uiOptions, receiverAddress, onComplete, onError, onCancel, connectOptions, connectLocale, purchaseData, paymentLinkId, presetOptions, paymentMethods = ["crypto", "card"], showThirdwebBranding = true, supportedTokens, country = "US", }) {
    // Initialize adapters
    ...
    return (_jsxs(Container, { flex: "column", fullHeight: true, children: [state.value === "error" && state.context.currentError && (_jsx(ErrorBanner, { client: client, error: state.context.currentError, onCancel: () => {
                ...
                state.context.receiverAddress && (_jsx(PaymentSelection, { client: client, connectLocale: connectLocale || en, connectOptions: modifiedConnectOptions, destinationAmount: state.context.destinationAmount, destinationToken: state.context.destinationToken, feePayer: uiOptions.mode === "direct_payment"
                    ...
                    send({ type: "BACK" });
                }, onError: handleError, onPaymentMethodSelected: handlePaymentMethodSelected, paymentMethods: paymentMethods, receiverAddress: state.context.receiverAddress, currency: uiOptions.currency, supportedTokens: supportedTokens, country: country })), state.value === "quote" &&
