...
function TransactionModalContent(props) {
    ...
    return (_jsx(BridgeOrchestrator, { country: props.country, client: props.client, connectLocale: localeQuery.data, connectOptions: undefined, onCancel: props.onClose, onComplete: () => {
            setScreen("execute-tx");
