...
export declare function PaymentSelection({ destinationToken, client, destinationAmount, receiverAddress, onPaymentMethodSelected, onError, onBack, connectOptions, connectLocale, includeDestinationToken, paymentMethods, supportedTokens, feePayer, currency, country, }: PaymentSelectionProps): import("react/jsx-runtime").JSX.Element;
